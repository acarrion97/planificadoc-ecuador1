...
export const destrezasLengua: Destreza[] = [
  ...
  // Bloque 3: Lectura
  {
    ...
    bloque: 3,
    secuencial: 1,
    descripcion: "Muestra capacidad de escucha al mantener el tema de conversación e intercambiar ideas, y sigue las pautas básicas de la comunicación oral. (I.3., I.4.).",
    objetivos: ["O.LL.2. Valorar la diversidad lingüística y cultural del país mediante el conocimiento y uso de algunas palabras y frases de las lenguas originarias."],
  ...
  },
  {
    ...
    bloque: 3,
    secuencial: 2,
    descripcion: "Interviene espontáneamente en situaciones informales de comunicación oral, expresa ideas, experiencias y necesidades con un vocabulario pertinente a la situación comunicativa, y sigue las pautas básicas de la comunicación oral. (I.3.).",
    objetivos: ["O.LL.2. Valorar la diversidad lingüística y cultural del país mediante el conocimiento y uso de algunas palabras y frases de las lenguas originarias."],
    criteriosEvaluacion: ["CE.LL.2.3. Criterio de evaluación del currículo priorizado."],
    indicadoresEvaluacion: ["I.LL.2.3.1. Indicador de evaluación del currículo priorizado."],
  },
  {
    ...
    bloque: 3,
    secuencial: 3,
    descripcion: "Diseña un cartel o anuncio publicitario que promueva el uso de medios de transporte sostenibles en su comunidad. (I.1., I.3., J.3.) 17 Área del conocimiento/asignatura: Criterios de evaluación Lengua y Literatura Destrezas con criterios de desempeño Indicadores de evaluación.",
    objetivos: ["O.LL.2. Valorar la diversidad lingüística y cultural del país mediante el conocimiento y uso de algunas palabras y frases de las lenguas originarias."],
    criteriosEvaluacion: ["CE.LL.2.3. Criterio de evaluación del currículo priorizado."],
    indicadoresEvaluacion: ["I.LL.2.3.1. Indicador de evaluación del currículo priorizado."],
  },
  ...
  // Bloque 4: Escritura
  {
    ...
    bloque: 4,
    secuencial: 1,
    descripcion: "(J.4., I.3.) CE.LL.2.5. Comprende contenidos implícitos y explícitos, emite criterios, opiniones y juicios de valor sobre textos literarios y no literarios, mediante el uso de diferentes estrategias para construir significados.",
    objetivos: ["O.LL.2. Valorar la diversidad lingüística y cultural del país mediante el conocimiento y uso de algunas palabras y frases de las lenguas originarias."],
  ...
  },
  {
    ...
    bloque: 5,
    secuencial: 2,
    descripcion: "Comprende los contenidos implícitos de un texto basándose en inferencias espacio-temporales, referenciales y de causa-efecto, y amplía la comprensión de un texto mediante la identificación de los significados de las palabras, utilizando estrategias de derivación (familia de palabras), sinonimia-anto.",
    objetivos: ["O.LL.2. Valorar la diversidad lingüística y cultural del país mediante el conocimiento y uso de algunas palabras y frases de las lenguas originarias."],
    criteriosEvaluacion: ["CE.LL.2.5. Criterio de evaluación del currículo priorizado."],
    indicadoresEvaluacion: ["I.LL.2.5.1. Indicador de evaluación del currículo priorizado."],
  },
  {
    ...
    bloque: 5,
    secuencial: 3,
    descripcion: "Construye criterios, opiniones y emite juicios acerca del contenido de un texto, al distinguir realidad y ficción, hechos, datos y opiniones, y desarrolla estrategias cognitivas como lectura de paratextos, establecimiento del propósito de lectura, relectura, relectura selectiva y parafraseo, para au.",
    objetivos: ["O.LL.2. Valorar la diversidad lingüística y cultural del país mediante el conocimiento y uso de algunas palabras y frases de las lenguas originarias."],
    criteriosEvaluacion: ["CE.LL.2.5. Criterio de evaluación del currículo priorizado."],
    indicadoresEvaluacion: ["I.LL.2.5.1. Indicador de evaluación del currículo priorizado."],
  },
  {
    ...
    bloque: 5,
    secuencial: 4,
    descripcion: "Explorar y motivar la escritura creativa al interactuar de manera lúdica con textos literarios leídos o escuchados (privilegiando textos ecuatorianos, populares y de autor).",
    objetivos: ["O.LL.2. Valorar la diversidad lingüística y cultural del país mediante el conocimiento y uso de algunas palabras y frases de las lenguas originarias."],
    criteriosEvaluacion: ["CE.LL.2.5. Criterio de evaluación del currículo priorizado."],
    indicadoresEvaluacion: ["I.LL.2.5.1. Indicador de evaluación del currículo priorizado."],
  },
  ...
  // Bloque 7: Bloque 7
  {
    ...
    bloque: 7,
    secuencial: 1,
    descripcion: "Escoge, de una selección previa realizada por el docente, textos de la biblioteca del aula, de la escuela y de la web y los consulta para satisfacer sus necesidades personales, de recreación, información y aprendizaje, enriqueciendo sus ideas e indagando temas de interés. (J.4., I.2.",
    objetivos: ["O.LL.2. Valorar la diversidad lingüística y cultural del país mediante el conocimiento y uso de algunas palabras y frases de las lenguas originarias."],
  ...
  // Bloque 8: Bloque 8
  {
    ...
    bloque: 8,
    secuencial: 1,
    descripcion: ") (J.2., I.3.) 19 Área del conocimiento/asignatura: Criterios de evaluación CE.LL.2.9. Utiliza elementos de la lengua apropiados para diferentes tipos de textos narrativos y descriptivos; emplea una diversidad de formatos, recursos y materiales para comunicar ideas con eficiencia.",
    objetivos: ["O.LL.2. Valorar la diversidad lingüística y cultural del país mediante el conocimiento y uso de algunas palabras y frases de las lenguas originarias."],
  ...
  // Bloque 5: Literatura
  {
    ...
    bloque: 5,
    secuencial: 1,
    descripcion: "Identifica, compara y contrasta fuentes consultadas en bibliotecas y en la web, registra la información consultada en esquemas de diverso tipo y genera criterios para el análisis de su confiabilidad. (J.2., I.4.).",
    objetivos: ["O.LL.3. Comprender discursos orales en diversos contextos de la actividad social y cultural y analizarlos con sentido crítico."],
  ...
  },
  {
    ...
    bloque: 7,
    secuencial: 2,
    descripcion: "Elige lecturas basándose en preferencias personales de autores, géneros o temas, maneja diversos soportes para formarse como lector autónomo y participa en discusiones literarias, desarrollando progresivamente la lectura crítica. (J.4., S.4.).",
    objetivos: ["O.LL.3. Comprender discursos orales en diversos contextos de la actividad social y cultural y analizarlos con sentido crítico."],
    criteriosEvaluacion: ["CE.LL.3.7. Criterio de evaluación del currículo priorizado."],
    indicadoresEvaluacion: ["I.LL.3.7.1. Indicador de evaluación del currículo priorizado."],
  },
  // Bloque 8: Bloque 8
  {
    ...
    bloque: 8,
    secuencial: 1,
    descripcion: "Reinventa textos literarios, reconociendo la fuente original, los relaciona con el contexto cultural propio y de otros entornos, incorpora recursos del lenguaje figurado y usa diversos medios y recursos (incluidas las TIC) para recrearlos. (J.2., I.2.).",
    objetivos: ["O.LL.3. Comprender discursos orales en diversos contextos de la actividad social y cultural y analizarlos con sentido crítico."],
  ...
  // Bloque 2: Comunicación oral
  {
    ...
    bloque: 2,
    secuencial: 1,
    descripcion: ") CE.LL.4.3. Valora el contenido explícito de dos o más textos orales, identificando contradicciones, ambigüedades, falacias, distorsiones, desviaciones en el discurso; y reflexiona sobre los efectos del uso de estereotipos y prejuicios en la comunicación.",
    objetivos: ["O.LL.4. Participar de manera fluida y eficiente en diversas situaciones de comunicación oral, formales y no formales."],
  ...
  // Bloque 3: Lectura
  {
    ...
    bloque: 3,
    secuencial: 1,
    descripcion: ") 16 CE.LL.4.4. Organiza sus discursos según las estructuras básicas de la lengua oral, utiliza un vocabulario acorde a la intención (construir acuerdos, solucionar problemas, etc.) y al contexto e integra una variedad de recursos, formatos y soportes, evaluando su impacto en la audiencia.",
    objetivos: ["O.LL.4. Participar de manera fluida y eficiente en diversas situaciones de comunicación oral, formales y no formales."],
  ...
  // Bloque 6: Bloque 6
  {
    ...
    bloque: 6,
    secuencial: 1,
    descripcion: ") CE.LL.4.6. Consulta bibliotecas y recursos digitales en la web, comparándolos y valorándolos en función de la confiabilidad de la fuente, el propósito de la lectura y la calidad de la información, recogiéndola, contrastándola y organizándola en esquemas de diverso tipo.",
    objetivos: ["O.LL.4. Participar de manera fluida y eficiente en diversas situaciones de comunicación oral, formales y no formales."],
  ...
  // Bloque 8: Bloque 8
  {
    ...
    bloque: 8,
    secuencial: 2,
    descripcion: ") CE.LL.4.9. Compone y recrea textos literarios que adaptan o combinan diversas estructuras y recursos literarios, expresa intenciones determinadas (ironía, sarcasmo, humor, etc.",
    objetivos: ["O.LL.4. Participar de manera fluida y eficiente en diversas situaciones de comunicación oral, formales y no formales."],
  ...
  },
  {
    ...
    bloque: 4,
    secuencial: 2,
    descripcion: "Interpreta los aspectos formales y el contenido de un texto, en función del propósito comunicativo, el contexto sociocultural y el punto de vista del autor; recoge, compara y organiza la información consultada, mediante el uso de esquemas y estrategias personales. (J.4., I.3.).",
    objetivos: ["O.LL.5. Leer de manera autónoma y aplicar estrategias cognitivas y metacognitivas de comprensión, según el propósito de lectura."],
    criteriosEvaluacion: ["CE.LL.5.4. Criterio de evaluación del currículo priorizado."],
    indicadoresEvaluacion: ["I.LL.5.4.1. Indicador de evaluación del currículo priorizado."],
  },
  ...
  // Bloque 5: Literatura
  {
    ...
    bloque: 5,
    secuencial: 1,
    descripcion: "Consulta bases de datos di- gitales y otros recursos de la web con capacidad para seleccionar y valorar fuentes según el propósito de lectura, su confiabilidad y punto de vista; recoge, compara y organiza la información consultada, esquemas y estrategias personales. (J.4., I.3.",
    objetivos: ["O.LL.5. Leer de manera autónoma y aplicar estrategias cognitivas y metacognitivas de comprensión, según el propósito de lectura."],
