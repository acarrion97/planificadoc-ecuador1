...
- [x] 2.1 Reordenar `STEP_LABELS` a ["Identificacion", "Diagnóstico", "Semana 1", "Semanas 2-3", "Semanas 4-5", "Resultado"] y reindexar `validateStep`, `handleGenerate` y el botón "← Volver a Generar"
...
- [x] 2.5 "Crear evaluación" desde el paso abre `/evaluacion-diagnostica`; al volver (`router.back()`) permite vincular la nueva; cambiar de evaluación vinculada reconfirma si aplica la regla 2.4
